...
#define ERR_AT_CME_FILE_OPEN_FAIL 1001
#define ERR_AT_CME_FILE_CLOSE_FAIL 1002
#define ERR_AT_CME_FILE_NOT_OPENED 1003
#define ERR_AT_CME_FILE_WRITE_FAIL 1004
#define ERR_AT_CME_FILE_SEEK_FAIL 1005
#define ERR_AT_CME_FILE_GET_SIZE_FAIL 1006
#define ERR_AT_CME_FILE_DEL_FAIL 1007
#define ERR_AT_CME_FILE_READ_FAIL 1008
#define ERR_AT_CME_FILE_EXIST_OPENED_FILE 1009
#define ERR_AT_CME_FILE_NOT_CLOSED 1010
#endif
 ...
 * @param errcode   CME error code
 */
void atCmdRespCmeErrorCBB(atCmdEngine_t *engine, int errcode);
#endif
...
#ifdef CONFIG_FIBOCOM_BASE
void atCmdRespDefUrcData(const char *text, size_t length);
void atCmdFTPRespOK(atCmdEngine_t *engine);
void atCmdRespDefUartText(const char *text);
#endif

#ifdef CONFIG_FIBOCOM_BASE
void atCmdRespDefUrcInfo(const char *text, size_t length);
#endif
//OSI_EXTERN_C_END
#endif
