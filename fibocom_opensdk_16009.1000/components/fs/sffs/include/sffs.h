...
/**
 * set a switch to control the behavior of file open.
 *
 * By default, \p sffsOpen will prevent opening the same file twice or more
 * at the same time, except all opening are in only-read mode.
 *
 * After calling this function and set \p flag to false, the \p sffsOpen
 * will disable the preventing behavior.
 *
 * @param flag      true or false
 */
void sffsSetMultiOpenControl(bool flag);
