...
CHAR *_fx_final_directory_name_extract(CHAR *source_ptr, CHAR *dest_ptr);
...
UINT _fx_directory_list(FX_MEDIA *media_ptr, CHAR *name_ptr, FX_DIR_ENTRY *entry_ptr, CHAR **name_buf);
