...
#define FX_INT_SAVE_AREA UX_INTERRUPT_SAVE_AREA
#define FX_DISABLE_INTS UX_DISABLE
#define FX_RESTORE_INTS UX_RESTORE
#endif
...
#define FX_LOCAL_PATH_SETUP extern UX_THREAD *_tx_thread_current_ptr;
#else
#define FX_NO_LOCAL_PATH
#endif
#endif
...
#define FX_MESSAGE_ERROR 0x98

static inline char *fx_errornum2string(UINT error_num)
{
    char *string = NULL;
    ...
    case FX_MEDIA_NOT_OPEN:
        string = "media not open !";
        break;
    default:
        string = "unknow filex error num !";
        break;
    }
...
#ifndef FX_MEDIA_EXFAT_BITMAP_CACHE_LEN
#define FX_MEDIA_EXFAT_BITMAP_CACHE_LEN 512
#endif
    UCHAR *fx_media_exfat_bitmap_cache;
...
#define fx_directory_list _fx_directory_list
...
UINT fx_directory_list(FX_MEDIA *media_ptr, CHAR *name_ptr, FX_DIR_ENTRY *entry_ptr, CHAR **name_buf);
