 ...
 */
#ifndef __UX_HCD_MUSB_SPRD_HSDMA__
#define __UX_HCD_MUSB_SPRD_HSDMA__

#define CONFIG_USB_SPRD_DMA_V3
...
struct sprd_musb_dma_controller
{
    ...
    void *base;
    u32 used_channels;
    UX_SEMAPHORE *dma_semaphore;
    //wait_queue_head_t	wait;
};

u32 musb_linknode_full(struct musb *musb, u32 is_tx);
int sprd_dma_interrupt(struct musb *musb, u32 int_hsdma);
