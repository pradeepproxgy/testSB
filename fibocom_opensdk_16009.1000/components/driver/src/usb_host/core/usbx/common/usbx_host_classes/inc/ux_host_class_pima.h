...
#define UX_HOST_CLASS_PIMA_CLASS_TRANSFER_TIMEOUT 30000
...
#define UX_HOST_CLASS_PIMA_UNICODE_MAX_LENGTH 512
#define UX_HOST_CLASS_PIMA_ARRAY_MAX_LENGTH 256
#define UX_HOST_CLASS_PIMA_DATE_TIME_STRING_MAX_LENGTH 128
...
#define UX_HOST_CLASS_PIMA_MAX_PAYLOAD (1024 * 5)
...
#define UX_HOST_CLASS_PIMA_CONTAINER_SIZE_FOR_DWC 0x200
...
typedef struct UX_HOST_CLASS_PIMA_STRUCT
{
    ...
    UX_MUTEX *ux_host_class_pima_mutex;
...
typedef struct UX_HOST_CLASS_PIMA_SESSION_STRUCT
{
    ...
    VOID(*ux_host_class_pima_session_event_callback)
    (struct UX_HOST_CLASS_PIMA_EVENT_STRUCT *pima_event);
...
#define UX_HOST_CLASS_PIMA_OBJECT_MAX_LENGTH 1024
...
typedef struct UX_HOST_CLASS_PIMA_DEVICE_STRUCT
{
    ...
    ULONG operations_supported_len;
    ULONG events_supported_len;
    ULONG properties_supported_len;
    ULONG capture_formats_len;
    ULONG image_formats_len;
...
UINT _ux_host_class_pima_command(UX_HOST_CLASS_PIMA *pima, UX_HOST_CLASS_PIMA_COMMAND *command,
                                 ULONG direction, UCHAR *data_out, ULONG data_out_length, UCHAR **data_in, ULONG *data_in_length,
...
UINT _ux_host_class_pima_num_objects_get(UX_HOST_CLASS_PIMA *pima, UX_HOST_CLASS_PIMA_SESSION *pima_session, ULONG storage_id,
                                         ULONG object_format_code, ULONG object_handle_association);
...
UINT _ux_host_class_pima_object_handles_get(UX_HOST_CLASS_PIMA *pima, UX_HOST_CLASS_PIMA_SESSION *pima_session,
                                            ULONG **object_handles_array, ULONG storage_id, ULONG object_format_code, ULONG object_handle_association);
...
UINT _ux_host_class_pima_read(UX_HOST_CLASS_PIMA *pima, UCHAR **data_in, ULONG *data_in_length, ULONG max_payload_length);
...
UINT _ux_host_class_pima_storage_ids_get(UX_HOST_CLASS_PIMA *pima, UX_HOST_CLASS_PIMA_SESSION *pima_session, ULONG **storage_ids_array);
