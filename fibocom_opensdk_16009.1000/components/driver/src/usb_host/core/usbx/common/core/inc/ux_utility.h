...
//UINT            _ux_utility_msg_send(UX_MSG *msg);
UINT _ux_utility_msg_send(UX_THREAD *thread_id, UX_CALLBACK callback, MSG_TYPE type, VOID *ctx);
...
UINT _ux_utility_thread_create(UX_THREAD **thread_ptr,
                               CHAR *name,
...
UINT _ux_utility_timer_create(UX_TIMER **timer, CHAR *timer_name, VOID (*expiration_function)(void *),
                              VOID *expiration_input, ULONG ms,
...
#define _ux_system_error_handler(system_level, system_context, error_code) \
    do                                                                     \
    {                                                                      \
    } while (0)
#define _ux_utility_error_callback_register(error_callback) \
    do                                                      \
    {                                                       \
    } while (0)
#else
...
#define UX_UTILITY_ADD_SAFE(add_a, add_b, result, status) \
    do                                                    \
    {                                                     \
...
#define UX_UTILITY_MULC_SAFE(mul_v, mul_c, result, status) \
    do                                                     \
    {                                                      \
...
#define UX_UTILITY_MULV_SAFE(mul_v0, mul_v1, result, status) \
    do                                                       \
    {                                                        \
...
#define ux_utility_msg_send _ux_utility_msg_send
