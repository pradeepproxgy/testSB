...
#define UX_THREAD_PRIORITY_ENUM OSI_PRIORITY_NORMAL_PLUS
#else
...
#ifdef CONFIG_8850CM_TARGET
#define UX_THREAD_PRIORITY_CLASS OSI_PRIORITY_NORMAL_PLUS
#else
...
#ifdef CONFIG_8850CM_TARGET
#define UX_THREAD_PRIORITY_KEYBOARD OSI_PRIORITY_NORMAL_PLUS
#else
...
#ifdef CONFIG_8850CM_TARGET
#define UX_THREAD_PRIORITY_HCD OSI_PRIORITY_ABOVE_NORMAL_PLUS
#else
...
#ifdef CONFIG_8850CM_TARGET
#define UX_THREAD_PRIORITY_DCD OSI_PRIORITY_ABOVE_NORMAL_PLUS
#else
