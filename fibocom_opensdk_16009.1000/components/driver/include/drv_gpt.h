...
/**
 * @brief lowpower gpt enable
 *
 * @param d           GPT instance
 * @param channel     GPT channel
 */
void drvGptEnable_lp(drvGpt_t *d, drvPmwChanne channel);
...
void drvGptReloadDuty(drvGpt_t *d, uint16_t duty);
void drvGptClearIrq_unlock(drvGpt_t * d);
#endif
