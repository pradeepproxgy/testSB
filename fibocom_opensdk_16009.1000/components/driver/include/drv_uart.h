...
/**
 * @brief is UART in hardware automatic flow control mode enable
 *
 * @param uart      the UART driver
 * @return
 *      - true      hardware automatic flow control enable
 *      - false     no hardware flow control
 */
bool drvUartIsHAFC(drvUart_t *d);
#endif
#ifdef __cplusplus
}
#endif
