...
int nvmReadImei(int index, nvmImeiStr_t *str);
#endif
/**
...
#ifdef CONFIG_FIBOCOM_BASE
    int nvmReadMs(int index, char *fg);
    int nvmWriteMs(int index, char *fg);
    int nvmReadCA(int index, char *fg);
    int nvmWriteCA(int index, char *fg);
    int nvmReadVTA(int index, char *fg);
    int nvmWriteVTA(int index, char *fg);
    int nvmReadVTD(int index, char *fg);
    int nvmWriteVTD(int index, char *fg);
#endif
