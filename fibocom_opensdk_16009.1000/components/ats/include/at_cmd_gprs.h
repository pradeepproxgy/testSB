...
//#if defined(CONFIG_AT_PSM_SUPPORT) //modify by fibocom for psm compile error from platform 20220427
...
//#endif //modify by fibocom for psm compile error from platform 20220427
