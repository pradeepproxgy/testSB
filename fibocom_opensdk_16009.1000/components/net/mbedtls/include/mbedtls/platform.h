...
#define mbedtls_calloc(n, size)    calloc(n,size)
...
#else
#include "osi_log.h"
#define mbedtls_printf(...)     OSI_LOGI(0x0, __VA_ARGS__)
...
#else
#define mbedtls_snprintf   snprintf //MBEDTLS_PLATFORM_STD_SNPRINTF
