...
//adapter for unisoc chip.
#define SUPPORT_UNISOC_ADAPTER 1
#ifdef SUPPORT_UNISOC_ADAPTER
#include "net_config.h"
#ifdef CONFIG_MBEDTLS_LIB_SUPPORT
#include "mbedtls_config.h"
#endif
#ifdef CONFIG_MBEDTLS_SSL_TLS
#define HAVE_MBEDDTLS
//#define HAVE_MBEDDTLS_DEBUG
#endif
#define WITHOUT_ASYNC       1
