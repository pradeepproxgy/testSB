...
BOOL app_WPHTTPGet(Http_info *http_info1);
BOOL app_WPHTTPPost(Http_info *http_info1);
BOOL app_WPHTTPPut(Http_info *http_info1);
BOOL app_WPHTTPHead(Http_info *http_info1);
BOOL app_WPHTTPOptions(Http_info *http_info1);
BOOL app_WPHTTPTrace(Http_info *http_info1);
BOOL app_WPHTTPDelete(Http_info *http_info1);
BOOL app_WPHTTPDownLoad(Http_info *http_info1, packet_handler_t handler);
BOOL app_WPHTTPAuthorization(Http_info *http_info1);
