...
bool Http_validate_url(char *url_char);
bool Http_init(CgHttpApi *cg_http_api, char *url_char);

#ifdef CONFIG_HTTP_API_V1
...
bool Http_redirect(nHttp_info *http_info1);
...
bool Http_getn_range(nHttp_info *http_info, bool user_need);
bool Http_headn(nHttp_info *http_info1);
bool Http_postn(nHttp_info *http_info1);
bool Http_post_cplog(nHttp_info *http_info1, char *resdata);
