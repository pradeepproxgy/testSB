...
#define MUPNP_HTTP_API_KEY "api-key"
...
#define MUPNP_HTTP_X_FORWARDED_FOR  "x-forward-for"
/**** SOAP Extention ****/
...
/**** API_KEY ****/
#define mupnp_http_request_setapikey(httpReq, value) mupnp_http_packet_setheadervalue((mUpnpHttpPacket*)httpReq, MUPNP_HTTP_API_KEY, value)
#define mupnp_http_request_getapikey(httpReq) mupnp_http_packet_getheadervalue((mUpnpHttpPacket*)httpReq, MUPNP_HTTP_API_KEY)
