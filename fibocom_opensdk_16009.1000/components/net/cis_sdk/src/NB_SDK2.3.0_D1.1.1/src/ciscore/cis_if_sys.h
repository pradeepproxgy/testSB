...
uint32_t    cissys_setFwVersion(uint8_t* version);
...
uint32_t    cissys_writeFwBytesNonBlock(cis_fw_context_t * context, uint32_t size, uint8_t* buffer, cissys_callback_t *cb);
