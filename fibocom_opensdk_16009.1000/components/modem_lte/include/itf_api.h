...
//merge patch SPCSS01326898 begin
#define API_ERRC_CDRX_RPT_CFG_REQ    ( HVY_API_GENERAL_IN + 0x64 )
//end
// General: API -> MMI
...
//merge patch SPCSS01326898 begin
#define API_CDRX_RPT_IND            ( HVY_API_GENERAL_OUT + 36 )
//end
...
#ifdef CONFIG_FIBOCOM_BASE //merge patch SPCSS01345734
