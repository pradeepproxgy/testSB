...
#define ANT_FS_READ_ONLY            (1<<4) 
#define ANT_FS_CREATE_ALWAYS        (1<<5)
#endif

#define ANT_FS_READ             O_RDONLY
#define ANT_FS_WRITE            O_WRONLY
#define ANT_FS_APPEND           O_APPEND
#define ANT_FS_READ_WRITE       O_RDWR
#define ANT_FS_READ_ONLY        O_RDONLY
#define ANT_FS_CREATE_ALWAYS    O_CREAT
#define ANT_FS_CREATE           O_CREAT
...
/* added by fibocom */
ant_s32 ant_fs_delete_files(char *dirname);
