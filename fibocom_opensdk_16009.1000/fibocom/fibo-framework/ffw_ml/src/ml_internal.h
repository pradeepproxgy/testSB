...
typedef struct list_head mlCharsetEntry_t;
typedef struct list_head mlCharsetHead_t;
...
void ffw_mlAddCharset(mlCharset_t *chset);
void ffw_mlAddGsm(void);
void ffw_mlAddUtf8(void);
void ffw_mlAddUtf16be(void);
void ffw_mlAddUtf16le(void);
void ffw_mlAddCP936(void);
void ffw_mlAddIso8859_1(void);
